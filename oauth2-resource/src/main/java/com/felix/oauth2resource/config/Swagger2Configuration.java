...
//            .globalRequestParameters(parameters)
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.felix.oauth2resource.controller"))
            .paths(PathSelectors.any())
            .build()
            .securitySchemes(List.of(new ApiKey(tokenAuthorization, HttpHeaders.AUTHORIZATION, In.HEADER.name())))
    ...
    List<SecurityReference> securityReferences() {
        ...
        return List.of(new SecurityReference(tokenAuthorization, authorizationScopes));
    }
}
