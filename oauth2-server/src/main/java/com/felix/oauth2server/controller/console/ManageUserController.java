...
public class ManageUserController {
    ...
    @ResponseBody
    public JsonObjects<UserAccount> getUsers(@RequestParam(value = "searchValue", required = false, defaultValue = "") String searchValue,
    ...
    @ResponseBody
    public UserAccount getUserDetails(@RequestParam(value = "id") Long id,
    ...
    @ResponseBody
    public ResponseResult<Object> updateUser(@RequestParam(value = "id", required = false) long id,
