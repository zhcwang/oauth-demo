...
import com.felix.oauth2server.repository.UserAccountRepository;
...
import com.felix.oauth2server.utils.DateUtil;
...
public class UserAccountServiceImpl implements UserAccountService {
    ...
    public UserAccount create(UserAccount userAccount) {
        ...
        if (exist != null) {
            throw new DuplicateKeyException(userAccount.getUsername() + " already exists!");
        }
    ...
    public UserAccount retrieveById(long id) {
        ...
        return dozerMapper.map(entityOptional.orElse(null), UserAccount.class);
    }
